...
if (a == "10") {
    ...
    document.write("(==) O valor " + a + " é não igual a 10!<br>");
}
...
if (a !== "10") {
    ...
    document.write("(!==) O valor " + a + " não idêntico a 10!<br>");
}
...
if (a >= e) {
    document.write("(>=) O valor " + a + " é maior ou igual que " + e + "!<br>");
} else {
    document.write("(>=) O valor " + a + " não é maior também não é igual que " + e + "!<br>");
}

if (a <= e) {
    document.write("(<=) O valor " + a + " é menor ou igual que " + e + "!<br>");
} else {
    document.write("(<=) O valor " + a + " não é menor também não é igual que " + e + "!<br>");
}
...
if ((a == 11) || (b == 12)) {
    ...
    document.write("(||) Nenhuma das duas condições são verdadeiras, o valor " + a + " não é igual a 11 e o valor " + b + " não é igual a 12!<br>");
}